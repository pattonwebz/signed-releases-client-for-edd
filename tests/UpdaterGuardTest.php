...
final class UpdaterGuardTest extends TestCase {
	...
	public function testValidPackagePassesAndReturnsVerifiedFile(): void {
		...
		$this->assertContains( 'srcl/verified', $this->firedActions() );
	...
	public function testModeFilterActsAsKillSwitch(): void {
		$GLOBALS['__wp_filter_overrides']['srcl/mode'] = VerificationPolicy::MODE_OFF;
	...
	public function testInvalidModeFilterFallsBackInsteadOfFatal(): void {
		...
		$GLOBALS['__wp_filter_overrides']['srcl/mode'] = 'enforcee';
	...
	public function testNonStringModeFilterFallsBackInsteadOfFatal(): void {
		...
		$GLOBALS['__wp_filter_overrides']['srcl/mode'] = array( 'enforce' );
	...
	public function testModeOverrideLogsSwitchoverOnceAndFiresAction(): void {
		...
		$this->assertSame(
			...
			$this->firedActionArgs( 'srcl/mode_switched' )
		);
	}
	...
	public function testModeOverrideRemovalLogsReturnToConfigured(): void {
		...
		unset( $GLOBALS['__wp_filter_overrides']['srcl/mode'] );
		$this->intercept( $guard );
	...
	public function testTrackRuntimeModeOnPollDetectsSwitchWithoutADownload(): void {
		...
		$GLOBALS['__wp_filter_overrides']['srcl/mode'] = VerificationPolicy::MODE_LOG;
		$guard->trackRuntimeMode();
	...
	public function testRegisterReturnsNullAndBlocksThatPluginOnBadPublicKey(): void {
		...
		$this->assertInstanceOf( \WP_Error::class, $result );
		$this->assertSame( 'srcl/misconfigured', $result->get_error_code() );
	...
	public function testFailureActionReceivesContractArgsWhenBlocking(): void {
		...
		$args = $this->firedActionArgs( 'srcl/failure' );
	...
	public function testVerifiedActionReceivesContractArgs(): void {
		...
		$args = $this->firedActionArgs( 'srcl/verified' );
	...
	public function testModeFilterCanEscalateLogToEnforce(): void {
		...
		$GLOBALS['__wp_filter_overrides']['srcl/mode'] = VerificationPolicy::MODE_ENFORCE;
	...
	public function testRuntimeEscalationWithoutFloorFailsClosed(): void {
		...
		$this->assertInstanceOf( \WP_Error::class, $result );
		$this->assertSame( 'srcl/no_floor', $result->get_error_code() );
